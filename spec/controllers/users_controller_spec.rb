		...
		describe "for signed in users" do
			before(:each) do
			  @user = test_sign_in(Factory(:user))
				Factory(:user,:email => "anather@example.com")
				Factory(:user,:email => "anather@example.net")
	...
	describe "POST 'create'" do
		...
		describe "success" do
			...
			it "should redirect to user show page" do
				post :create ,:user => @attr
#				response.should redirect_to(init_path(assigns(:user)))
	...
	describe "PUT 'update'" do
		...
		describe "success" do
			...
			before(:each) do
			  @attr = {:name => "New Name",:email=> "example@domain.com",	
								 :password =>"vinay007",:password_confirmation => "vinay007"}
			end
	...
	describe "authentication of edit/update actions" do
		...
		describe "for non signed in user" do
			...
			it "should deny access to update path" do
		...
		describe "for signed in users" do
			...
			it "should require matching users for 'updat'" do
